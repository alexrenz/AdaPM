...
class SimpleApp {
 ...
 protected:
  ...
  virtual inline bool Process(const Message& msg); // [sysChange]: changed this to bool (for message counts in Customer)
...
inline bool SimpleApp::Process(const Message& msg) {
  SimpleData recv;
